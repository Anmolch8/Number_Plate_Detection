...
class main:
    ...
    def loc(self,states,state):
        ...
        state_label=tkinter.Label(self.Labelframe,text='Recognised State : ',font=("Helvetica",22,'bold'),background='#262626',foreground='#F9A826')
        state_label.place(relx=0.06,rely=0.66)
        ans=tkinter.Label(self.Labelframe,font=("Helvetica",22,'bold'),background='#262626',foreground='white')
        ...
        self.b3=tkinter.Button(self.root,text="Next",font=("Helvetica",18,'bold') ,borderwidth=2,
                        ...
                        foreground='#ffffff',command=lambda:SearchVehicle.Vehicle_Plate(self.root,self.updated_no,self.tid1))
    ...
    def Detection(self):
        ...
        if len(self.filename) != 0:
                ...
                self.label1=tkinter.Label(self.F1,text="Detected License Plate",font=("Helvetica",28,'bold'),foreground='#F9A826',background='#262626')
                ...
                self.Labelframe=tkinter.LabelFrame(self.F1,text="Classify Image",borderwidth=3,bd=5,labelanchor=NW,font=('Helvetica',32,'bold')
                                    ,background='#262626',foreground="#58A6FF")
                self.Labelframe.place(relx=0.52,rely=0,relwidth=0.46,relheight=0.7)

                self.ocr=tkinter.Label(self.Labelframe,text="OCR image : ",background='#262626',foreground='#F9A826',font=("Helevetica",22,'bold'))
                ...
                recog_label=tkinter.Label(self.Labelframe,text="License Number :",font=('Helvetica',22,'bold'),background='#262626',foreground='#F9A826')
                ...
                self.e1=Entry(self.Labelframe,font=('Helvetica',22,'bold'),foreground='#262626',background='#F0F6FC', cursor="xterm #0000FF")
                ...
                self.edit=tkinter.Button(self.Labelframe,text="Modify",font=("Helvetica",14,'bold'),bg='#238636',
                                activebackground='#238636',activeforeground='#ffffff',foreground='#ffffff', command=lambda:self.loc(states,state))
    ...
    def __init__(self,tollid):
        ...
        self.root.iconbitmap("D:\\final toll tax system\\TollTaxSys\\icons\\add_winicon.ico")
        ...
        self.b1 = tkinter.Button(self.root, text="Click here to Choose file (.png,.jpg)", font=("Helvetica", 18), foreground='#262626',
