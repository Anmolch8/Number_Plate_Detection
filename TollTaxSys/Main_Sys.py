...
def log_true():
                        ...
                        bg=ImageTk.PhotoImage(Image.open("D:\\final toll tax system\\TollTaxSys\\toll1.jpg"))
                        master.iconbitmap("D:\\final toll tax system\\TollTaxSys\icons\\tollplaza1.ico")
                        img=ImageTk.PhotoImage(Image.open("D:\\final toll tax system\\TollTaxSys\\NH.png"))
